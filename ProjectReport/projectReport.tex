...
Finally, about the computational time, the new system lasts 6 seconds to filter 8 seconds of recording, which makes it efficient.
...
\end{itemize}
	...
	\end{itemize}
		...
		The \textit{Android Group} had to make some changes from the material sent by the \textit{Theory Group}. Due to some saturation, the \textit{NLMS Algorithm} was successfully tested.
